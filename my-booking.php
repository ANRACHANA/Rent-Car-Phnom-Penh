...
$cnt=$query->rowCount();
?>
<p>ចំនួនរថយន្ត <?php echo htmlentities($cnt);?> គ្រឿង</p>
...
<li>
    <p style="color:red">លេខកូដជួល <?php echo htmlentities($result->BookingNumber);?></p>
                ...
                <div class="vehicle_title">
                  ...
                  <div style="float: left"><p><b>មតិរបស់ អតិថជន:</b> <?php echo htmlentities($result->message);?></p></div>
                </div>
        ...
        <div>
            ...
            <?php } else { ?>
               ...
               <div class="btn outline btn-xs" style="color:blue">កំពុងស្នើសុំជួល...</div>
...
<hr />
              <?php }}  else { ?>
                <h5 align="center"> <a href="http://localhost/rent_car/car-listing.php" style="color:red">មិនទានមានការជួល</a></h5>
              <?php } ?>
